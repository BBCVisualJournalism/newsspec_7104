module.exports = function (grunt) {
    ...
    grunt.registerTask('nowWeCanCheckStage', ['Checking content on stage'], function () {
        ...
        try {
          // Query the entry
            stats = fs.lstatSync('/private/tmp/mounts/wwwlive' + '/news/special/' + pkg.year + '/newsspec_' + pkg.project_number + '/content/' + pkg.services.default);
          // Is it a directory?
            ...
            grunt.log.writeln('This content has not been staged - Fail: ' + e);
        }
    });
};